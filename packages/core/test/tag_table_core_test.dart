  ...
  group('tricky', () {
    ...
    testWidgets('TBODY height', (WidgetTester tester) async {
      ...
      expect(
          explained,
          equals('[Table:\n'
              '[CssBlock:child=[CssSizing:height=10.0,child=[CssBlock:child=[Padding:(1,1,1,1),child=[RichText:(:Foo)]]]]]\n'
              ']'));
    });
    ...
    testWidgets('TD height', (WidgetTester tester) async {
      ...
      expect(
          explained,
          equals('[Table:\n'
              '[CssBlock:child=[CssSizing:height=10.0,child=[Padding:(1,1,1,1),child=[RichText:(:Foo)]]]]\n'
              ']'));
    });
  });
}
