    ...
    testWidgets('useExplainer=false', (WidgetTester tester) async {
      ...
      expect(
          ...
          equals('TshWidget\n'
              ...
              '   ││)\n'
              '   │└CssBlock()\n'
              '   │ └RichText(textAlign: center, textDirection: ltr, text: "Caption")\n'
              '   └LayoutGrid()\n'
              ...
              '    │    └RichText(textDirection: ltr, text: "Header 1")\n'
              ...
              '    │  └CssBlock()\n'
              '    │   └Padding(padding: all(1.0))\n'
              '    │    └RichText(textDirection: ltr, text: "Header 2")\n'
              ...
              '    │  └CssBlock()\n'
              '    │   └Padding(padding: all(1.0))\n'
              '    │    └RichText(textDirection: ltr, text: "Value 1")\n'
              ...
              '       └CssBlock()\n'
              '        └Padding(padding: all(1.0))\n'
              '         └RichText(textDirection: ltr, text: "Value 2")\n'
              '\n'));
    });
  });
