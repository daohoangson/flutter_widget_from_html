...
- A: launch url via [`url_launcher`](https://pub.dartlang.org/packages/url_launcher), support base url resolver. Override `WidgetFactory::buildGestureTapCallbackForUrl` if you want to do something else onTap.
- H1/H2/H3/H4/H5/H6
