...
echo('<body>');
echo("<ul>\n");
echo("  <li>The Flutter rendering column is golden image (e.g. screenshot test) generated by running this package in a virtual machine.</li>\n");
echo("  <li>The Browser rendering column is the same input HTML being rendered by your current browser to compare.</li>\n");
echo("  <li>Some golden image has two renderings, one by <var>flutter_widget_from_html_core</var> and another by <var>flutter_widget_from_html</var>, this means the enhanced package renders the tag slightly better.</li>\n");
echo("</ul>\n");
