...
<div class="mw-parser-output">
   ...
   <table class="infobox vcard">
      ...
      <tbody>
         ...
         <tr>
            ...
            <td class="infobox-data" style="line-height: 1.35em;">September&nbsp;4, 1998<span class="noprint">; 22 years ago</span><span style="display:none">&nbsp;(<span class="bday dtstart published updated">1998-09-04</span>)</span><sup class="reference"><a href="#cite_note-5">[a]</a></sup> in <a href="/wiki/Menlo_Park,_California" title="Menlo Park, California">Menlo Park</a>, California, United States</td>
         </tr>
         <tr>
            ...
            <td class="infobox-data label" style="line-height: 1.35em;">
               <div class="plainlist">
                  <ul>
                     ...
                     <li><a href="/wiki/Queenstown,_Singapore" title="Queenstown, Singapore">Queenstown</a>, <a href="/wiki/Singapore" title="Singapore">Singapore</a> (<a href="/wiki/Asia-Pacific" title="Asia-Pacific">Asia-Pacific</a>)<sup class="reference"><a href="#cite_note-6">[5]</a></sup></li>
                  </ul>
               </div>
            </td>
         </tr>
         ...
         <tr>
            <td colspan="2" class="infobox-below" style="line-height: 1.35em;"><b>Footnotes&nbsp;/ references</b><br><sup class="reference"><a href="#cite_note-7">[6]</a></sup><sup class="reference"><a href="#cite_note-8">[7]</a></sup><sup class="reference"><a href="#cite_note-9">[8]</a></sup><sup class="reference"><a href="#cite_note-:0-10">[9]</a></sup></td>
         </tr>
      </tbody>
   </table>
   ...
   <p>Google began in January 1996 as a research project by <a href="/wiki/Larry_Page" title="Larry Page">Larry Page</a> and <a href="/wiki/Sergey_Brin" title="Sergey Brin">Sergey Brin</a> when they were both PhD students at <a href="/wiki/Stanford_University" title="Stanford University">Stanford University</a> in <a href="/wiki/Stanford,_California" title="Stanford, California">Stanford, California</a>.<sup class="reference"><a href="#cite_note-milestones-20">[19]</a></sup> The project initially involved an unofficial "third founder", Scott Hassan, the original lead programmer who wrote much of the code for the original <a href="/wiki/Google_Search" title="Google Search">Google Search</a> engine, but he left before Google was officially founded as a company;<sup class="reference"><a href="#cite_note-vanityfair-21">[20]</a></sup><sup class="reference"><a href="#cite_note-22">[21]</a></sup> Hassan went on to pursue a career in <a href="/wiki/Robotics" title="Robotics">robotics</a> and founded the company <a href="/wiki/Willow_Garage" title="Willow Garage">Willow Garage</a> in 2006.<sup class="reference"><a href="#cite_note-23">[22]</a></sup><sup class="reference"><a href="#cite_note-24">[23]</a></sup></p>
   <p>While conventional search engines ranked results by counting how many times the search terms appeared on the page, they theorized about a better system that analyzed the relationships among websites.<sup class="reference"><a href="#cite_note-25">[24]</a></sup> They called this algorithm <a href="/wiki/PageRank" title="PageRank">PageRank</a>; it determined a website's <a href="/wiki/Relevance_(information_retrieval)" title="Relevance (information retrieval)">relevance</a> by the number of pages, and the importance of those pages that linked back to the original site.<sup class="reference"><a href="#cite_note-26">[25]</a></sup><sup class="reference"><a href="#cite_note-27">[26]</a></sup> Page told his ideas to Hassan, who began writing the code to implement Page's ideas.<sup class="reference"><a href="#cite_note-vanityfair-21">[20]</a></sup></p>
   <p>Page and Brin originally nicknamed the new search engine "<a href="/wiki/BackRub_(search_engine)" class="mw-redirect" title="BackRub (search engine)">BackRub</a>", because the system checked backlinks to estimate the importance of a site.<sup class="reference"><a href="#cite_note-28">[27]</a></sup><sup class="reference"><a href="#cite_note-29">[28]</a></sup><sup class="reference"><a href="#cite_note-30">[29]</a></sup> Hassan as well as Alan Steremberg were cited by Page and Brin as being critical to the development of Google. <a href="/wiki/Rajeev_Motwani" title="Rajeev Motwani">Rajeev Motwani</a> and <a href="/wiki/Terry_Winograd" title="Terry Winograd">Terry Winograd</a> later co-authored with Page and Brin the first paper about the project, describing PageRank and the initial prototype of the Google search engine, published in 1998. <a href="/wiki/H%C3%A9ctor_Garc%C3%ADa-Molina" title="Héctor García-Molina">Héctor García-Molina</a> and <a href="/wiki/Jeff_Ullman" class="mw-redirect" title="Jeff Ullman">Jeff Ullman</a> were also cited as contributors to the project.<sup class="reference"><a href="#cite_note-originalpaper-31">[30]</a></sup> PageRank was influenced by a similar page-ranking and site-scoring algorithm earlier used for <a href="/wiki/RankDex" class="mw-redirect" title="RankDex">RankDex</a>, developed by <a href="/wiki/Robin_Li" title="Robin Li">Robin Li</a> in 1996, with Larry Page's PageRank patent including a citation to Li's earlier RankDex patent; Li later went on to create the Chinese search engine <a href="/wiki/Baidu" title="Baidu">Baidu</a>.<sup class="reference"><a href="#cite_note-32">[31]</a></sup><sup class="reference"><a href="#cite_note-33">[32]</a></sup><sup class="reference"><a href="#cite_note-34">[33]</a></sup></p>
   <p>Eventually, they changed the name to Google; the name of the search engine originated from a misspelling of the word "<a href="/wiki/Googol" title="Googol">googol</a>",<sup class="reference"><a href="#cite_note-35">[34]</a></sup><sup class="reference"><a href="#cite_note-36">[35]</a></sup> the number 1 followed by 100 zeros, which was picked to signify that the search engine was intended to provide large quantities of information.<sup class="reference"><a href="#cite_note-37">[36]</a></sup></p>
   <div class="thumb tright">
      <div class="thumbinner" style="width:252px;">
         ...
         <div class="thumbcaption">
            ...
            Google's original homepage had a simple design because the company founders had little experience in <a href="/wiki/HTML" title="HTML">HTML</a>, the <a href="/wiki/Markup_language" title="Markup language">markup language</a> used for designing web pages.<sup class="reference"><a href="#cite_note-38">[37]</a></sup>
         </div>
      </div>
   </div>
   <p>The domain name <code>www.google.com</code> was registered on September 15, 1997,<sup class="reference"><a href="#cite_note-39">[38]</a></sup> and the company was incorporated on September 4, 1998. It was based in the garage of a friend (<a href="/wiki/Susan_Wojcicki" title="Susan Wojcicki">Susan Wojcicki</a><sup class="reference"><a href="#cite_note-milestones-20">[19]</a></sup>) in <a href="/wiki/Menlo_Park,_California" title="Menlo Park, California">Menlo Park, California</a>. <a href="/wiki/Craig_Silverstein" title="Craig Silverstein">Craig Silverstein</a>, a fellow PhD student at Stanford, was hired as the first employee.<sup class="reference"><a href="#cite_note-milestones-20">[19]</a></sup><sup class="reference"><a href="#cite_note-40">[39]</a></sup><sup class="reference"><a href="#cite_note-41">[40]</a></sup></p>
   <p>Google was initially funded by an August 1998 contribution of $100,000 from <a href="/wiki/Andy_Bechtolsheim" title="Andy Bechtolsheim">Andy Bechtolsheim</a>, co-founder of <a href="/wiki/Sun_Microsystems" title="Sun Microsystems">Sun Microsystems</a>; the money was given before Google was incorporated.<sup class="reference"><a href="#cite_note-42">[41]</a></sup><sup class="reference"><a href="#cite_note-Bechtolsheim-43">[42]</a></sup> Google received money from three other <a href="/wiki/Angel_investor" title="Angel investor">angel investors</a> in 1998: <a href="/wiki/Amazon.com" class="mw-redirect" title="Amazon.com">Amazon.com</a> founder <a href="/wiki/Jeff_Bezos" title="Jeff Bezos">Jeff Bezos</a>, Stanford University computer science professor <a href="/wiki/David_Cheriton" title="David Cheriton">David Cheriton</a>, and entrepreneur <a href="/wiki/Ram_Shriram" title="Ram Shriram">Ram Shriram</a>.<sup class="reference"><a href="#cite_note-endofworld-44">[43]</a></sup> Between these initial investors, friends, and family Google raised around 1 million dollars, which is what allowed them to open up their original shop in <a href="/wiki/Menlo_Park,_California" title="Menlo Park, California">Menlo Park, California</a>.<sup class="reference"><a href="#cite_note-45">[44]</a></sup></p>
   <p>After some additional, small investments through the end of 1998 to early 1999,<sup class="reference"><a href="#cite_note-endofworld-44">[43]</a></sup> a new $25 million round of funding was announced on June 7, 1999,<sup class="reference"><a href="#cite_note-46">[45]</a></sup> with major investors including the <a href="/wiki/Venture_capital" title="Venture capital">venture capital</a> firms <a href="/wiki/Kleiner_Perkins" title="Kleiner Perkins">Kleiner Perkins</a> and <a href="/wiki/Sequoia_Capital" title="Sequoia Capital">Sequoia Capital</a>.<sup class="reference"><a href="#cite_note-Bechtolsheim-43">[42]</a></sup></p>
   <h3><span class="mw-headline" id="Growth">Growth</span></h3>
   <p>In March 1999, the company moved its offices to <a href="/wiki/Palo_Alto,_California" title="Palo Alto, California">Palo Alto, California</a>,<sup class="reference"><a href="#cite_note-47">[46]</a></sup> which is home to several prominent <a href="/wiki/Silicon_Valley" title="Silicon Valley">Silicon Valley</a> technology start-ups.<sup class="reference"><a href="#cite_note-48">[47]</a></sup> The next year, Google began selling advertisements associated with search keywords against Page and Brin's initial opposition toward an advertising-funded search engine.<sup class="reference"><a href="#cite_note-49">[48]</a></sup><sup class="reference"><a href="#cite_note-milestones-20">[19]</a></sup> To maintain an uncluttered page design, advertisements were solely text-based.<sup class="reference"><a href="#cite_note-50">[49]</a></sup> In June 2000, it was announced that Google would become the default search engine provider for <a href="/wiki/Yahoo!" title="Yahoo!">Yahoo!</a>, one of the most popular websites at the time, replacing <a href="/wiki/Inktomi" title="Inktomi">Inktomi</a>.<sup class="reference"><a href="#cite_note-51">[50]</a></sup><sup class="reference"><a href="#cite_note-52">[51]</a></sup></p>
   <div class="thumb tright">
      <div class="thumbinner" style="width:172px;">
         ...
         <div class="thumbcaption">
            ...
            Google's first production server.<sup class="reference"><a href="#cite_note-53">[52]</a></sup>
         </div>
      </div>
   </div>
   <p>In 2003, after outgrowing two other locations, the company leased an office complex from <a href="/wiki/Silicon_Graphics" title="Silicon Graphics">Silicon Graphics</a>, at 1600 Amphitheatre Parkway in <a href="/wiki/Mountain_View,_California" title="Mountain View, California">Mountain View, California</a>.<sup class="reference"><a href="#cite_note-sgibldg-54">[53]</a></sup> The complex became known as the <a href="/wiki/Googleplex" title="Googleplex">Googleplex</a>, a play on the word <a href="/wiki/Googolplex" title="Googolplex">googolplex</a>, the number one followed by a googol zeroes. Three years later, Google bought the property from SGI for $319&nbsp;million.<sup class="reference"><a href="#cite_note-googleplexpurchase-55">[54]</a></sup> By that time, the name "Google" had found its way into everyday language, causing the verb "<a href="/wiki/Google_(verb)" title="Google (verb)">google</a>" to be added to the <i><a href="/wiki/Merriam-Webster_Collegiate_Dictionary" class="mw-redirect" title="Merriam-Webster Collegiate Dictionary">Merriam-Webster Collegiate Dictionary</a></i> and the <i><a href="/wiki/Oxford_English_Dictionary" title="Oxford English Dictionary">Oxford English Dictionary</a></i>, denoted as: "to use the Google search engine to obtain information on the Internet".<sup class="reference"><a href="#cite_note-56">[55]</a></sup><sup class="reference"><a href="#cite_note-57">[56]</a></sup> Additionally, in 2001 Google's Investors felt the need to have a strong internal management, and they agreed to hire <a href="/wiki/Eric_Schmidt" title="Eric Schmidt">Eric Schmidt</a> as the Chairman and CEO of Google <sup class="reference"><a href="#cite_note-Google_Inc-58">[57]</a></sup></p>
   <h3><span class="mw-headline" id="Initial_public_offering">Initial public offering</span></h3>
   <p>On August 19, 2004, Google became a <a href="/wiki/Public_company" title="Public company">public company</a> via an <a href="/wiki/Initial_public_offering" title="Initial public offering">initial public offering</a>. At that time Larry Page, Sergey Brin, and Eric Schmidt agreed to work together at Google for 20 years, until the year 2024.<sup class="reference"><a href="#cite_note-59">[58]</a></sup> The company offered 19,605,052 shares at a price of $85 per share.<sup class="reference"><a href="#cite_note-IPO-60">[59]</a></sup><sup class="reference"><a href="#cite_note-:1-61">[60]</a></sup> Shares were sold in an online auction format using a system built by <a href="/wiki/Morgan_Stanley" title="Morgan Stanley">Morgan Stanley</a> and <a href="/wiki/Credit_Suisse" title="Credit Suisse">Credit Suisse</a>, underwriters for the deal.<sup class="reference"><a href="#cite_note-62">[61]</a></sup><sup class="reference"><a href="#cite_note-63">[62]</a></sup> The sale of $1.67 billion gave Google a <a href="/wiki/Market_capitalization" title="Market capitalization">market capitalization</a> of more than $23 billion.<sup class="reference"><a href="#cite_note-washpost-64">[63]</a></sup></p>
   <div class="thumb tleft">
      <div class="thumbinner" style="width:172px;">
   ...
   <p>On November 13, 2006, Google acquired <a href="/wiki/YouTube" title="YouTube">YouTube</a> for $1.65 billion in Google stock,<sup class="reference"><a href="#cite_note-65">[64]</a></sup><sup class="reference"><a href="#cite_note-66">[65]</a></sup><sup class="reference"><a href="#cite_note-67">[66]</a></sup><sup class="reference"><a href="#cite_note-68">[67]</a></sup> On March 11, 2008, Google acquired <a href="/wiki/DoubleClick" title="DoubleClick">DoubleClick</a> for $3.1&nbsp;billion, transferring to Google valuable relationships that DoubleClick had with Web publishers and advertising agencies.<sup class="reference"><a href="#cite_note-69">[68]</a></sup><sup class="reference"><a href="#cite_note-70">[69]</a></sup></p>
   <p>In May 2011, the number of monthly unique visitors to Google surpassed one billion for the first time.<sup class="reference"><a href="#cite_note-71">[70]</a></sup><sup class="reference"><a href="#cite_note-72">[71]</a></sup></p>
   <p>By 2011, Google was handling approximately 3 billion searches per day. To handle this workload, Google built 11 <a href="/wiki/Data_centers" class="mw-redirect" title="Data centers">data centers</a> around the world with some several thousand servers in each. These data centers allowed Google to handle the ever changing workload more efficiently.<sup class="reference"><a href="#cite_note-Google_Inc-58">[57]</a></sup></p>
   <p>In May 2012, Google acquired <a href="/wiki/Motorola_Mobility" title="Motorola Mobility">Motorola Mobility</a> for $12.5&nbsp;billion, in its largest acquisition to date.<sup class="reference"><a href="#cite_note-73">[72]</a></sup><sup class="reference"><a href="#cite_note-74">[73]</a></sup><sup class="reference"><a href="#cite_note-75">[74]</a></sup> This purchase was made in part to help Google gain Motorola's considerable patent portfolio on mobile phones and wireless technologies, to help protect Google in its ongoing patent disputes with other companies,<sup class="reference"><a href="#cite_note-76">[75]</a></sup> mainly <a href="/wiki/Apple_Inc." title="Apple Inc.">Apple</a> and <a href="/wiki/Microsoft" title="Microsoft">Microsoft</a>,<sup class="reference"><a href="#cite_note-77">[76]</a></sup> and to allow it to continue to freely offer <a href="/wiki/Android_(operating_system)" title="Android (operating system)">Android</a>.<sup class="reference"><a href="#cite_note-cnet-78">[77]</a></sup></p>
   <h3><span class="mw-headline" id="2012_onward">2012 onward</span></h3>
   <p>In June 2013, Google acquired <a href="/wiki/Waze" title="Waze">Waze</a>, a $966 million deal.<sup class="reference"><a href="#cite_note-79">[78]</a></sup> While Waze would remain an independent entity, its social features, such as its crowdsourced location platform, were reportedly valuable integrations between Waze and <a href="/wiki/Google_Maps" title="Google Maps">Google Maps</a>, Google's own mapping service.<sup class="reference"><a href="#cite_note-80">[79]</a></sup></p>
   <p>Google announced the launch of a new company, called <a href="/wiki/Calico_(company)" title="Calico (company)">Calico</a>, on September 19, 2013, to be led by <a href="/wiki/Apple_Inc." title="Apple Inc.">Apple Inc.</a> chairman <a href="/wiki/Arthur_D._Levinson" title="Arthur D. Levinson">Arthur Levinson</a>. In the official public statement, Page explained that the "health and well-being" company would focus on "the challenge of ageing and associated diseases".<sup class="reference"><a href="#cite_note-81">[80]</a></sup></p>
   <div class="thumb tright">
      <div class="thumbinner" style="width:172px;">
   ...
   <p>On January 26, 2014, Google announced it had agreed to acquire <a href="/wiki/DeepMind_Technologies" class="mw-redirect" title="DeepMind Technologies">DeepMind Technologies</a>, a privately held artificial intelligence company from <a href="/wiki/London" title="London">London</a>.<sup class="reference"><a href="#cite_note-82">[81]</a></sup> Technology news website <i><a href="/wiki/Recode" title="Recode">Recode</a></i> reported that the company was purchased for $400 million though it was not disclosed where the information came from. A Google spokesman would not comment of the price.<sup class="reference"><a href="#cite_note-Helgren-_DeepMind-83">[82]</a></sup><sup class="reference"><a href="#cite_note-Ribeiro-_DeepMind-84">[83]</a></sup> The purchase of DeepMind aids in Google's recent growth in the artificial intelligence and robotics community.<sup class="reference"><a href="#cite_note-85">[84]</a></sup></p>
   <p>According to <a href="/wiki/Interbrand" title="Interbrand">Interbrand</a>'s annual Best Global Brands report, Google has been the second most valuable brand in the world (behind <a href="/wiki/Apple_Inc." title="Apple Inc.">Apple Inc.</a>) in 2013,<sup class="reference"><a href="#cite_note-86">[85]</a></sup> 2014,<sup class="reference"><a href="#cite_note-87">[86]</a></sup> 2015,<sup class="reference"><a href="#cite_note-88">[87]</a></sup> and 2016, with a valuation of $133 billion.<sup class="reference"><a href="#cite_note-89">[88]</a></sup></p>
   <p>On August 10, 2015, Google announced plans to reorganize its various interests as a <a href="/wiki/Conglomerate_(company)" title="Conglomerate (company)">conglomerate</a> called <a href="/wiki/Alphabet_Inc." title="Alphabet Inc.">Alphabet Inc.</a> Google became Alphabet's largest subsidiary and the umbrella company for Alphabet's Internet interests. Upon completion of the restructure, <a href="/wiki/Sundar_Pichai" title="Sundar Pichai">Sundar Pichai</a> became CEO of Google, replacing <a href="/wiki/Larry_Page" title="Larry Page">Larry Page</a>, who became CEO of Alphabet.<sup class="reference"><a href="#cite_note-90">[89]</a></sup><sup class="reference"><a href="#cite_note-91">[90]</a></sup><sup class="reference"><a href="#cite_note-92">[91]</a></sup></p>
   <div class="thumb tright">
      <div class="thumbinner" style="width:222px;">
   ...
   <p>On August 8, 2017, Google fired employee <a href="/wiki/James_Damore" class="mw-redirect" title="James Damore">James Damore</a> after he distributed a memo throughout the company which argued that bias and "<a href="/wiki/Google%27s_Ideological_Echo_Chamber" title="Google's Ideological Echo Chamber">Google's Ideological Echo Chamber</a>" clouded their thinking about diversity and inclusion, and that it is also biological factors, not discrimination alone, that cause the average woman to be less interested than men in technical positions.<sup class="reference"><a href="#cite_note-93">[92]</a></sup> Google CEO Sundar Pichai accused Damore in violating company policy by "advancing harmful gender stereotypes in our workplace", and he was fired on the same day.<sup class="reference"><a href="#cite_note-94">[93]</a></sup><sup class="reference"><a href="#cite_note-95">[94]</a></sup><sup class="reference"><a href="#cite_note-96">[95]</a></sup> <i>New York Times</i> columnist <a href="/wiki/David_Brooks_(political_commentator)" class="mw-redirect" title="David Brooks (political commentator)">David Brooks</a> argued Pichai had mishandled the case, and called for his resignation.<sup class="reference"><a href="#cite_note-BrooksNYT-97">[96]</a></sup><sup class="reference"><a href="#cite_note-98">[97]</a></sup></p>
   <p>Between 2018 and 2019, <a href="/wiki/Google_worker_organization" title="Google worker organization">tensions between the company's leadership and its workers escalated</a> as staff protested company decisions on internal sexual harassment, <a href="/wiki/Dragonfly_(search_engine)" title="Dragonfly (search engine)">Dragonfly</a>, a censored Chinese search engine, and <a href="/wiki/Project_Maven" class="mw-redirect" title="Project Maven">Project Maven</a>, a military drone artificial intelligence, which had been seen as areas of revenue growth for the company.<sup class="reference"><a href="#cite_note-99">[98]</a></sup><sup class="reference"><a href="#cite_note-Verge_busting-100">[99]</a></sup> On October 25, 2018, <i><a href="/wiki/The_New_York_Times" title="The New York Times">The New York Times</a></i> published the <i>exposé</i>, "How Google Protected <a href="/wiki/Andy_Rubin" title="Andy Rubin">Andy Rubin</a>, the ‘Father of Android’". The company subsequently announced that "48 employees have been fired over the last two years" for sexual misconduct.<sup class="reference"><a href="#cite_note-101">[100]</a></sup> On November 1, 2018, more than 20,000 Google employees and contractors staged a global walk-out to protest the company's handling of sexual harassment complaints.<sup class="reference"><a href="#cite_note-102">[101]</a></sup><sup class="reference"><a href="#cite_note-103">[102]</a></sup> Later in 2019, some workers accused the company of retaliating against internal activists.<sup class="reference"><a href="#cite_note-Verge_busting-100">[99]</a></sup></p>
   <p>On March 19, 2019, Google announced that it would enter the video game market, launching a <a href="/wiki/Cloud_gaming" title="Cloud gaming">cloud gaming</a> platform called <a href="/wiki/Google_Stadia" title="Google Stadia">Google Stadia</a>.<sup class="reference"><a href="#cite_note-unveils-104">[103]</a></sup></p>
   <p>On June 3, 2019, the <a href="/wiki/United_States_Department_of_Justice" title="United States Department of Justice">United States Department of Justice</a> reported that it would investigate Google for <a href="/wiki/Antitrust" class="mw-redirect" title="Antitrust">antitrust</a> violations.<sup class="reference"><a href="#cite_note-105">[104]</a></sup> This led to the filing of an antitrust lawsuit in October 2020, on the grounds the company had abused a monopoly position in the <a href="/wiki/Web_search_engine" class="mw-redirect" title="Web search engine">search</a> and <a href="/wiki/Search_advertising" title="Search advertising">search advertising</a> markets.<sup class="reference"><a href="#cite_note-106">[105]</a></sup></p>
   <p>In December 2019, former <a href="/wiki/PayPal" title="PayPal">PayPal</a> <a href="/wiki/Chief_operating_officer" title="Chief operating officer">chief operating officer</a> Bill Ready became Google's new commerce chief. Ready's role will not be directly involved with <a href="/wiki/Google_Pay" title="Google Pay">Google Pay</a>.<sup class="reference"><a href="#cite_note-107">[106]</a></sup></p>
   <p>In April 2020, due to the <a href="/wiki/COVID-19_pandemic" title="COVID-19 pandemic">COVID-19 pandemic</a>, Google announced several cost-cutting measures. Such measures included slowing down hiring for the remainder of 2020, except for a small number of strategic areas, recalibrating the focus and pace of investments in areas like data centers and machines, and non-business essential marketing and travel.<sup class="reference"><a href="#cite_note-108">[107]</a></sup></p>
   <p>The <a href="/wiki/2020_Google_services_outages" title="2020 Google services outages">2020 Google services outages</a> disrupted Google services: one in August that affected Google Drive among others, another in November affecting YouTube, and a third in December affecting the entire suite of Google applications. All three outages were resolved within hours.<sup class="reference"><a href="#cite_note-109">[108]</a></sup><sup class="reference"><a href="#cite_note-110">[109]</a></sup><sup class="reference"><a href="#cite_note-111">[110]</a></sup></p>
   <p>In January 2021, the <a href="/wiki/Australian_Government" title="Australian Government">Australian Government</a> proposed legislation that would require Google and Facebook to pay media companies for the right to use their content. In response, Google threatened to close off access to its search engine in Australia.<sup class="reference"><a href="#cite_note-112">[111]</a></sup></p>
   <p>In March 2021, Google reportedly paid $20 million for <a href="/wiki/Ubisoft" title="Ubisoft">Ubisoft</a> ports on <a href="/wiki/Google_Stadia" title="Google Stadia">Google Stadia</a>.<sup class="reference"><a href="#cite_note-113">[112]</a></sup> Google spent "tens of millions of dollars" on getting major publishers such as <a href="/wiki/Ubisoft" title="Ubisoft">Ubisoft</a> and Take-Two to bring some of their biggest games to Stadia. </p>
   ...
   <p>Google <a href="/wiki/Search_engine_indexing" title="Search engine indexing">indexes</a> billions of web pages to allow users to search for the information they desire through the use of keywords and <a href="/wiki/Operator_(computer_programming)" title="Operator (computer programming)">operators</a>.<sup class="reference"><a href="#cite_note-114">[113]</a></sup> According to <a href="/wiki/ComScore" class="mw-redirect" title="ComScore">comScore</a> market research from November 2009, <a href="/wiki/Google_Search" title="Google Search">Google Search</a> is the dominant search engine in the United States market, with a <a href="/wiki/Market_share" title="Market share">market share</a> of 65.6%.<sup class="reference"><a href="#cite_note-comscore-115">[114]</a></sup> In May 2017, Google enabled a new "Personal" tab in Google Search, letting users search for content in their Google accounts' various services, including email messages from <a href="/wiki/Gmail" title="Gmail">Gmail</a> and photos from <a href="/wiki/Google_Photos" title="Google Photos">Google Photos</a>.<sup class="reference"><a href="#cite_note-116">[115]</a></sup><sup class="reference"><a href="#cite_note-117">[116]</a></sup></p>
   <p>Google launched its <a href="/wiki/Google_News" title="Google News">Google News</a> service in 2002, an automated service which summarizes news articles from various websites.<sup class="reference"><a href="#cite_note-118">[117]</a></sup> Google also hosts <a href="/wiki/Google_Books" title="Google Books">Google Books</a>, a service which searches the text found in books in its database and shows limited previews or and the full book where allowed.<sup class="reference"><a href="#cite_note-119">[118]</a></sup></p>
   ...
   <p>Google offers <a href="/wiki/Gmail" title="Gmail">Gmail</a> for <a href="/wiki/Email" title="Email">email</a>,<sup class="reference"><a href="#cite_note-128">[127]</a></sup> <a href="/wiki/Google_Calendar" title="Google Calendar">Google Calendar</a> for time-management and scheduling,<sup class="reference"><a href="#cite_note-129">[128]</a></sup> <a href="/wiki/Google_Maps" title="Google Maps">Google Maps</a> for mapping, navigation and <a href="/wiki/Satellite_imagery" title="Satellite imagery">satellite imagery</a>,<sup class="reference"><a href="#cite_note-130">[129]</a></sup> <a href="/wiki/Google_Drive" title="Google Drive">Google Drive</a> for <a href="/wiki/File_hosting_service" title="File hosting service">cloud storage</a> of files,<sup class="reference"><a href="#cite_note-verge-drive-announced-131">[130]</a></sup> <a href="/wiki/Google_Docs" title="Google Docs">Google Docs</a>, <a href="/wiki/Google_Sheets" title="Google Sheets">Sheets</a> and <a href="/wiki/Google_Slides" title="Google Slides">Slides</a> for productivity,<sup class="reference"><a href="#cite_note-verge-drive-announced-131">[130]</a></sup> <a href="/wiki/Google_Photos" title="Google Photos">Google Photos</a> for photo storage and sharing,<sup class="reference"><a href="#cite_note-132">[131]</a></sup> <a href="/wiki/Google_Keep" title="Google Keep">Google Keep</a> for <a href="/wiki/Note-taking" title="Note-taking">note-taking</a>,<sup class="reference"><a href="#cite_note-133">[132]</a></sup> <a href="/wiki/Google_Translate" title="Google Translate">Google Translate</a> for language translation,<sup class="reference"><a href="#cite_note-134">[133]</a></sup> <a href="/wiki/YouTube" title="YouTube">YouTube</a> for video viewing and sharing,<sup class="reference"><a href="#cite_note-135">[134]</a></sup> <a href="/wiki/Google_My_Business" class="mw-redirect" title="Google My Business">Google My Business</a> for managing public business information,<sup class="reference"><a href="#cite_note-136">[135]</a></sup> and <a href="/wiki/Google_Duo" title="Google Duo">Duo</a> for social interaction.<sup class="reference"><a href="#cite_note-137">[136]</a></sup> In March 2019, Google unveiled a <a href="/wiki/Cloud_gaming" title="Cloud gaming">cloud gaming</a> service named <a href="/wiki/Google_Stadia" title="Google Stadia">Stadia</a>.<sup class="reference"><a href="#cite_note-unveils-104">[103]</a></sup></p>
   <p>Some Google services are not web-based. <a href="/wiki/Google_Earth" title="Google Earth">Google Earth</a>, launched in 2005, allowed users to see high-definition satellite pictures from all over the world for free through a client software downloaded to their computers.<sup class="reference"><a href="#cite_note-138">[137]</a></sup></p>
   <h4><span class="mw-headline" id="Software">Software</span></h4>
   <p>Google develops the <a href="/wiki/Android_(operating_system)" title="Android (operating system)">Android</a> <a href="/wiki/Mobile_operating_system" title="Mobile operating system">mobile operating system</a>,<sup class="reference"><a href="#cite_note-139">[138]</a></sup> as well as its <a href="/wiki/Android_Wear" class="mw-redirect" title="Android Wear">smartwatch</a>,<sup class="reference"><a href="#cite_note-140">[139]</a></sup> <a href="/wiki/Android_TV" title="Android TV">television</a>,<sup class="reference"><a href="#cite_note-141">[140]</a></sup> <a href="/wiki/Android_Auto" title="Android Auto">car</a>,<sup class="reference"><a href="#cite_note-142">[141]</a></sup> and <a href="/wiki/Internet_of_things" title="Internet of things">Internet of things</a>-enabled <a href="/wiki/Android_Things" title="Android Things">smart devices</a> variations.<sup class="reference"><a href="#cite_note-143">[142]</a></sup></p>
   <p>It also develops the <a href="/wiki/Google_Chrome" title="Google Chrome">Google Chrome</a> web browser,<sup class="reference"><a href="#cite_note-144">[143]</a></sup> and <a href="/wiki/Chrome_OS" title="Chrome OS">Chrome OS</a>, an operating system based on Chrome.<sup class="reference"><a href="#cite_note-145">[144]</a></sup></p>
   ...
   <p>In January 2010, Google released <a href="/wiki/Nexus_One" title="Nexus One">Nexus One</a>, the first Android phone under its own brand.<sup class="reference"><a href="#cite_note-146">[145]</a></sup> It spawned a number of phones and tablets under the "<a href="/wiki/Google_Nexus" title="Google Nexus">Nexus</a>" branding<sup class="reference"><a href="#cite_note-147">[146]</a></sup> until its eventual discontinuation in 2016, replaced by a new brand called <a href="/wiki/Google_Pixel" title="Google Pixel">Pixel</a>.<sup class="reference"><a href="#cite_note-Pixel_inside_story-148">[147]</a></sup></p>
   <p>In 2011, the <a href="/wiki/Chromebook" title="Chromebook">Chromebook</a> was introduced, which runs on <a href="/wiki/Chrome_OS" title="Chrome OS">Chrome OS</a>.<sup class="reference"><a href="#cite_note-149">[148]</a></sup></p>
   <p>In July 2013, Google introduced the <a href="/wiki/Chromecast" title="Chromecast">Chromecast</a> dongle, which allows users to stream content from their smartphones to televisions.<sup class="reference"><a href="#cite_note-150">[149]</a></sup><sup class="reference"><a href="#cite_note-151">[150]</a></sup></p>
   <p>In June 2014, Google announced <a href="/wiki/Google_Cardboard" title="Google Cardboard">Google Cardboard</a>, a simple cardboard viewer that lets user place their smartphone in a special front compartment to view <a href="/wiki/Virtual_reality" title="Virtual reality">virtual reality</a> (VR) media.<sup class="reference"><a href="#cite_note-152">[151]</a></sup><sup class="reference"><a href="#cite_note-153">[152]</a></sup></p>
   <ul>
      <li><a href="/wiki/Google_Home" class="mw-redirect" title="Google Home">Google Home</a>, a voice assistant smart speaker that can answer voice queries, play music, find information from apps (calendar, weather etc.), and control third-party smart home appliances (users can tell it to turn on the lights, for example). The Google Home line also includes variants such as the <a href="/wiki/Google_Home_Hub" class="mw-redirect" title="Google Home Hub">Google Nest Hub</a>, <a href="/wiki/Google_Home_Mini" class="mw-redirect" title="Google Home Mini">Google Home Mini</a>, <a href="/wiki/Nest_Hub_Max" class="mw-redirect" title="Nest Hub Max">Nest Hub Max</a>, <a href="/wiki/Google_Nest_(smart_speakers)#Nest_Mini_(second_generation)" title="Google Nest (smart speakers)">Nest Mini (second generation)</a>, and <a href="/wiki/Google_Home_Max" class="mw-redirect" title="Google Home Max">Google Home Max</a><sup class="reference"><a href="#cite_note-154">[153]</a></sup></li>
      <li><a href="/wiki/Google_Daydream" title="Google Daydream">Daydream View</a> <a href="/wiki/Virtual_reality" title="Virtual reality">virtual reality</a> headset that lets <a href="/wiki/Android_(operating_system)" title="Android (operating system)">Android</a> users with compatible Daydream-ready smartphones put their phones in the headset and enjoy VR content.<sup class="reference"><a href="#cite_note-155">[154]</a></sup></li>
      <li><a href="/wiki/Google_Nest_Wifi" title="Google Nest Wifi">Google Wifi</a>, a connected set of <a href="/wiki/Wi-Fi" title="Wi-Fi">Wi-Fi</a> routers to simplify and extend coverage of home Wi-Fi.<sup class="reference"><a href="#cite_note-156">[155]</a></sup></li>
   </ul>
   ...
   <p><a href="/wiki/Google_Workspace" title="Google Workspace">Google Workspace</a>, (formerly G Suite until October 2020<sup class="reference"><a href="#cite_note-157">[156]</a></sup>) is a monthly subscription offering for organizations and businesses to get access to a collection of Google's services, including <a href="/wiki/Gmail" title="Gmail">Gmail</a>, <a href="/wiki/Google_Drive" title="Google Drive">Google Drive</a> and <a href="/wiki/Google_Docs" title="Google Docs">Google Docs</a>, <a href="/wiki/Google_Sheets" title="Google Sheets">Google Sheets</a> and <a href="/wiki/Google_Slides" title="Google Slides">Google Slides</a>, with additional administrative tools, unique domain names, and 24/7 support.<sup class="reference"><a href="#cite_note-158">[157]</a></sup></p>
   <p>On September 24, 2012,<sup class="reference"><a href="#cite_note-159">[158]</a></sup> Google launched <a href="/wiki/Google_for_Entrepreneurs" class="mw-redirect" title="Google for Entrepreneurs">Google for Entrepreneurs</a>, a largely not-for-profit <a href="/wiki/Business_incubator" title="Business incubator">business incubator</a> providing startups with <a href="/wiki/Coworking" title="Coworking">co-working spaces</a> known as Campuses, with assistance to startup founders that may include workshops, conferences, and mentorships.<sup class="reference"><a href="#cite_note-160">[159]</a></sup> Presently, there are 7 Campus locations in <a href="/wiki/Berlin" title="Berlin">Berlin</a>, <a href="/wiki/London" title="London">London</a>, <a href="/wiki/Madrid" title="Madrid">Madrid</a>, <a href="/wiki/Seoul" title="Seoul">Seoul</a>, <a href="/wiki/S%C3%A3o_Paulo" title="São Paulo">São Paulo</a>, <a href="/wiki/Tel_Aviv" title="Tel Aviv">Tel Aviv</a>, and <a href="/wiki/Warsaw" title="Warsaw">Warsaw</a>.</p>
   <p>On March 15, 2016, Google announced the introduction of Google Analytics 360 Suite, "a set of integrated data and marketing analytics products, designed specifically for the needs of enterprise-class marketers" which can be integrated with <a href="/wiki/BigQuery" title="BigQuery">BigQuery</a> on the Google Cloud Platform. Among other things, the suite is designed to help "enterprise class marketers" "see the complete customer journey", generate "useful insights", and "deliver engaging experiences to the right people".<sup class="reference"><a href="#cite_note-161">[160]</a></sup> Jack Marshall of <i><a href="/wiki/The_Wall_Street_Journal" title="The Wall Street Journal">The Wall Street Journal</a></i> wrote that the suite competes with existing marketing cloud offerings by companies including <a href="/wiki/Adobe_Systems" class="mw-redirect" title="Adobe Systems">Adobe</a>, <a href="/wiki/Oracle_Corporation" title="Oracle Corporation">Oracle</a>, <a href="/wiki/Salesforce.com" class="mw-redirect" title="Salesforce.com">Salesforce</a>, and <a href="/wiki/IBM" title="IBM">IBM</a>.<sup class="reference"><a href="#cite_note-162">[161]</a></sup></p>
   <h3><span class="mw-headline" id="Internet_services">Internet services</span></h3>
   <p>In February 2010, Google announced the <a href="/wiki/Google_Fiber" title="Google Fiber">Google Fiber</a> project, with experimental plans to build an ultra-high-speed broadband network for 50,000 to 500,000 customers in one or more American cities.<sup class="reference"><a href="#cite_note-163">[162]</a></sup><sup class="reference"><a href="#cite_note-164">[163]</a></sup> Following Google's corporate restructure to make <a href="/wiki/Alphabet_Inc." title="Alphabet Inc.">Alphabet Inc.</a> its parent company, Google Fiber was moved to Alphabet's Access division.<sup class="reference"><a href="#cite_note-165">[164]</a></sup><sup class="reference"><a href="#cite_note-166">[165]</a></sup></p>
   <p>In April 2015, Google announced <a href="/wiki/Project_Fi" class="mw-redirect" title="Project Fi">Project Fi</a>, a mobile virtual network operator, that combines Wi-Fi and cellular networks from different telecommunication providers in an effort to enable seamless connectivity and fast Internet signal.<sup class="reference"><a href="#cite_note-167">[166]</a></sup><sup class="reference"><a href="#cite_note-168">[167]</a></sup><sup class="reference"><a href="#cite_note-169">[168]</a></sup></p>
   <p>In September 2016, Google began its Google Station initiative, a project for public Wi-Fi at railway stations in India. Caesar Sengupta, VP for Google's next billion users, told <i><a href="/wiki/The_Verge" title="The Verge">The Verge</a></i> that 15,000 people get online for the first time thanks to Google Station and that 3.5 million people use the service every month. The expansion meant that Google was looking for partners around the world to further develop the initiative, which promised "high-quality, secure, easily accessible Wi-Fi".<sup class="reference"><a href="#cite_note-170">[169]</a></sup> By December, Google Station had been deployed at 100 railway stations,<sup class="reference"><a href="#cite_note-171">[170]</a></sup> and in February, Google announced its intention to expand beyond railway stations, with a plan to bring citywide Wi-Fi to <a href="/wiki/Pune" title="Pune">Pune</a>.<sup class="reference"><a href="#cite_note-172">[171]</a></sup><sup class="reference"><a href="#cite_note-173">[172]</a></sup></p>
   <h3><span class="mw-headline" id="Other_products">Other products</span></h3>
   <p>In May 2011, Google announced <a href="/wiki/Google_Wallet" class="mw-redirect" title="Google Wallet">Google Wallet</a>, a mobile application for wireless payments.<sup class="reference"><a href="#cite_note-174">[173]</a></sup></p>
   <p>In 2013, Google launched <a href="/wiki/Google_Shopping_Express" class="mw-redirect" title="Google Shopping Express">Google Shopping Express</a>, a delivery service initially available only in San Francisco and Silicon Valley.<sup class="reference"><a href="#cite_note-175">[174]</a></sup></p>
   ...
   <p>Google's <a href="/wiki/Initial_public_offering" title="Initial public offering">initial public offering</a> (IPO) took place on August 19, 2004. At IPO, the company offered 19,605,052 shares at a price of $85 per share.<sup class="reference"><a href="#cite_note-IPO-60">[59]</a></sup><sup class="reference"><a href="#cite_note-:1-61">[60]</a></sup> The sale of $1.67 billion gave Google a <a href="/wiki/Market_capitalization" title="Market capitalization">market capitalization</a> of more than $23 billion.<sup class="reference"><a href="#cite_note-washpost-64">[63]</a></sup> The stock performed well after the IPO, with shares hitting $350 for the first time on October 31, 2007,<sup class="reference"><a href="#cite_note-176">[175]</a></sup> primarily because of strong sales and earnings in the <a href="/wiki/Online_advertising" title="Online advertising">online advertising</a> market.<sup class="reference"><a href="#cite_note-bowlingforgoogle-177">[176]</a></sup> The surge in stock price was fueled mainly by individual investors, as opposed to large institutional investors and <a href="/wiki/Mutual_fund" title="Mutual fund">mutual funds</a>.<sup class="reference"><a href="#cite_note-bowlingforgoogle-177">[176]</a></sup> GOOG shares split into GOOG <a href="/wiki/Class_C_share" class="mw-redirect" title="Class C share">class C shares</a> and GOOGL <a href="/wiki/Class_A_share" title="Class A share">class A shares</a>.<sup class="reference"><a href="#cite_note-178">[177]</a></sup> The company is listed on the <a href="/wiki/NASDAQ" class="mw-redirect" title="NASDAQ">NASDAQ</a> stock exchange under the <a href="/wiki/Ticker_symbol" title="Ticker symbol">ticker symbols</a> GOOGL and GOOG, and on the <a href="/wiki/Frankfurt_Stock_Exchange" title="Frankfurt Stock Exchange">Frankfurt Stock Exchange</a> under the ticker symbol GGQ1. These ticker symbols now refer to Alphabet Inc., Google's holding company, since the fourth quarter of 2015.<sup class="plainlinks noexcerpt noprint asof-tag update" style="display:none;"><a class="external text" href="https://en.wikipedia.org/w/index.php?title=Google&amp;action=edit">[update]</a></sup><sup class="reference"><a href="#cite_note-179">[178]</a></sup></p>
   <p>In the third-quarter of 2005, Google reported a 700% increase in profit, largely due to large companies shifting their advertising strategies from newspapers, magazines, and television to the Internet.<sup class="reference"><a href="#cite_note-180">[179]</a></sup><sup class="reference"><a href="#cite_note-181">[180]</a></sup><sup class="reference"><a href="#cite_note-182">[181]</a></sup></p>
   <p>For the 2006 fiscal year, the company reported $10.492 billion in total advertising revenues and only $112 million in licensing and other revenues.<sup class="reference"><a href="#cite_note-10-K-183">[182]</a></sup> In 2011, 96% of Google's revenue was derived from its advertising programs.<sup class="reference"><a href="#cite_note-Google-Inc-Jan-2012-10-K-184">[183]</a></sup> </p>
   <p>The year 2012 was the first time that Google generated $50 billion in annual revenue for the first time in 2012, generating $38 billion the previous year. In January 2013, then-CEO Larry Page commented, "We ended 2012 with a strong quarter ... Revenues were up 36% year-on-year, and 8% quarter-on-quarter. And we hit $50 billion in revenues for the first time last year – not a bad achievement in just a decade and a half."<sup class="reference"><a href="#cite_note-185">[184]</a></sup></p>
   <p>Google's consolidated revenue for the third quarter of 2013 was reported in mid-October 2013 as $14.89 billion, a 12 percent increase compared to the previous quarter.<sup class="reference"><a href="#cite_note-186">[185]</a></sup> Google's Internet business was responsible for $10.8 billion of this total, with an increase in the number of users' clicks on advertisements.<sup class="reference"><a href="#cite_note-187">[186]</a></sup> By January 2014, Google's market capitalization had grown to $397 billion.<sup class="reference"><a href="#cite_note-Marketwatch-188">[187]</a></sup></p>
   ...
   <p>Google uses various <a href="/wiki/Tax_avoidance" title="Tax avoidance">tax avoidance</a> strategies. On the <a href="/wiki/List_of_the_largest_information_technology_companies" class="mw-redirect" title="List of the largest information technology companies">list of the largest information technology companies</a>, it pays the lowest taxes to the countries of origin of its revenues. Google between 2007 and 2010 saved $3.1 billion in taxes by shuttling non-U.S. profits through <a href="/wiki/Ireland" title="Ireland">Ireland</a> and the <a href="/wiki/Netherlands" title="Netherlands">Netherlands</a> and then to <a href="/wiki/Bermuda" title="Bermuda">Bermuda</a>. Such techniques lower its non-U.S. tax rate to 2.3 per cent, while normally the corporate tax rate in for instance the UK is 28 per cent.<sup class="reference"><a href="#cite_note-189">[188]</a></sup> This has reportedly sparked a French investigation into Google's <a href="/wiki/Transfer_pricing" title="Transfer pricing">transfer pricing</a> practices.<sup class="reference"><a href="#cite_note-190">[189]</a></sup></p>
   <p>Google said it overhauled its controversial global tax structure and consolidated all of its intellectual property holdings back to the US.<sup class="reference"><a href="#cite_note-191">[190]</a></sup></p>
   <p>Google Vice-President <a href="/wiki/Matt_Brittin" title="Matt Brittin">Matt Brittin</a> testified to the <a href="/wiki/Public_Accounts_Committee_(United_Kingdom)" title="Public Accounts Committee (United Kingdom)">Public Accounts Committee</a> of the UK House of Commons that his UK sales team made no sales and hence owed no sales taxes to the UK.<sup class="reference"><a href="#cite_note-192">[191]</a></sup> In January 2016, Google reached a settlement with the UK to pay £130m in back taxes plus higher taxes in future.<sup class="reference"><a href="#cite_note-193">[192]</a></sup> In 2017, Google channeled $22.7 billion from the Netherlands to Bermuda to reduce its tax bill.<sup class="reference"><a href="#cite_note-194">[193]</a></sup></p>
   <p>In 2013, Google ranked 5th in <a href="/wiki/Lobbying_in_the_United_States" title="Lobbying in the United States">lobbying</a> spending, up from 213th in 2003. In 2012, the company ranked 2nd in campaign donations of technology and Internet sections.<sup class="reference"><a href="#cite_note-lobby1-195">[194]</a></sup></p>
   ...
   <p>On <i><a href="/wiki/Fortune_(magazine)" title="Fortune (magazine)">Fortune</a></i> magazine's list of the best companies to work for, Google ranked first in 2007, 2008 and 2012,<sup class="reference"><a href="#cite_note-best_company-211">[210]</a></sup><sup class="reference"><a href="#cite_note-212">[211]</a></sup><sup class="reference"><a href="#cite_note-213">[212]</a></sup> and fourth in 2009 and 2010.<sup class="reference"><a href="#cite_note-214">[213]</a></sup><sup class="reference"><a href="#cite_note-215">[214]</a></sup> Google was also nominated in 2010 to be the world's most attractive employer to graduating students in the Universum Communications talent attraction index.<sup class="reference"><a href="#cite_note-216">[215]</a></sup> Google's corporate philosophy includes principles such as "you can make money without doing evil," "you can be serious without a suit," and "work should be challenging and the challenge should be fun."<sup class="reference"><a href="#cite_note-217">[216]</a></sup></p>
   <p>As of September 30, 2020,<sup class="plainlinks noexcerpt noprint asof-tag update" style="display:none;"><a class="external text" href="https://en.wikipedia.org/w/index.php?title=Google&amp;action=edit">[update]</a></sup> Alphabet Inc. had 132,121 employees,<sup class="reference"><a href="#cite_note-218">[217]</a></sup> of which more than 100,000 worked for Google.<sup class="reference"><a href="#cite_note-:0-10">[9]</a></sup> Google's 2020<sup class="plainlinks noexcerpt noprint asof-tag update" style="display:none;"><a class="external text" href="https://en.wikipedia.org/w/index.php?title=Google&amp;action=edit">[update]</a></sup> diversity report states that 32 percent of its workforce are women and 68 percent are men, with the ethnicity of its workforce being predominantly white (51.7%) and Asian (41.9%).<sup class="reference"><a href="#cite_note-219">[218]</a></sup> Within tech roles, 23.6 percent were women; and 26.7 percent of leadership roles were held by women.<sup class="reference"><a href="#cite_note-220">[219]</a></sup> In addition to its 100,000+ full-time employees, Google used about 121,000 temporary workers and contractors, as of March&nbsp;2019<sup class="plainlinks noexcerpt noprint asof-tag update" style="display:none;"><a class="external text" href="https://en.wikipedia.org/w/index.php?title=Google&amp;action=edit">[update]</a></sup>.<sup class="reference"><a href="#cite_note-:0-10">[9]</a></sup></p>
   <p>Google's employees are hired based on a hierarchical system. Employees are split into six hierarchies based on experience and can range "from entry-level data center workers at level one to managers and experienced engineers at level six."<sup class="reference"><a href="#cite_note-221">[220]</a></sup> As a motivation technique, Google uses a policy known as <a href="/wiki/Innovation_Time_Off" class="mw-redirect" title="Innovation Time Off">Innovation Time Off</a>, where Google engineers are encouraged to spend 20% of their work time on projects that interest them. Some of Google's services, such as <a href="/wiki/Gmail" title="Gmail">Gmail</a>, <a href="/wiki/Google_News" title="Google News">Google News</a>, <a href="/wiki/Orkut" title="Orkut">Orkut</a>, and <a href="/wiki/AdSense" class="mw-redirect" title="AdSense">AdSense</a> originated from these independent endeavors.<sup class="reference"><a href="#cite_note-222">[221]</a></sup> In a talk at Stanford University, <a href="/wiki/Marissa_Mayer" title="Marissa Mayer">Marissa Mayer</a>, Google's Vice-President of Search Products and User Experience until July 2012, showed that half of all new product launches in the second half of 2005 had originated from the Innovation Time Off.<sup class="reference"><a href="#cite_note-223">[222]</a></sup></p>
   <p>In 2005, articles in <i><a href="/wiki/The_New_York_Times" title="The New York Times">The New York Times</a></i><sup class="reference"><a href="#cite_note-224">[223]</a></sup> and other sources began suggesting that Google had lost its anti-corporate, no evil philosophy.<sup class="reference"><a href="#cite_note-225">[224]</a></sup><sup class="reference"><a href="#cite_note-226">[225]</a></sup><sup class="reference"><a href="#cite_note-227">[226]</a></sup> In an effort to maintain the company's unique culture, Google designated a Chief Culture Officer whose purpose was to develop and maintain the culture and work on ways to keep true to the core values that the company was founded on.<sup class="reference"><a href="#cite_note-CCO-228">[227]</a></sup> Google has also faced allegations of <a href="/wiki/Sexism" title="Sexism">sexism</a> and <a href="/wiki/Ageism" title="Ageism">ageism</a> from former employees.<sup class="reference"><a href="#cite_note-229">[228]</a></sup><sup class="reference"><a href="#cite_note-230">[229]</a></sup> In 2013, a <a href="/wiki/High-Tech_Employee_Antitrust_Litigation" title="High-Tech Employee Antitrust Litigation">class action against</a> several <a href="/wiki/Silicon_Valley" title="Silicon Valley">Silicon Valley</a> companies, including Google, was filed for alleged "no cold call" agreements which restrained the recruitment of high-tech employees.<sup class="reference"><a href="#cite_note-231">[230]</a></sup> In a lawsuit filed January 8, 2018, multiple employees and job applicants alleged Google discriminated against a class defined by their “conservative political views[,] male gender[,] and/or […] Caucasian or Asian race”.<sup class="reference"><a href="#cite_note-:4-232">[231]</a></sup></p>
   <p>On January 25, 2020, the formation of an international workers union of Google employees, Alpha Global, was announced.<sup class="reference"><a href="#cite_note-233">[232]</a></sup> The coalition is made up of "13 different unions representing workers in 10 countries, including the United States, United Kingdom, and Switzerland."<sup class="reference"><a href="#cite_note-:5-234">[233]</a></sup> The group is affiliated with <a href="/wiki/UNI_Global_Union" title="UNI Global Union">UNI Global Union</a>, which represents nearly 20 million international workers from various unions and federations. The formation of the union is in response to persistent allegations of mistreatment of Google employees and a toxic workplace culture.<sup class="reference"><a href="#cite_note-:5-234">[233]</a></sup><sup class="reference"><a href="#cite_note-235">[234]</a></sup><sup class="reference"><a href="#cite_note-:4-232">[231]</a></sup> Google had previously been accused of surveilling and firing employees who were suspected of organizing a workers union.<sup class="reference"><a href="#cite_note-236">[235]</a></sup></p>
   ...
   <p>Google's headquarters in <a href="/wiki/Mountain_View,_California" title="Mountain View, California">Mountain View</a>, California is referred to as "the <a href="/wiki/Googleplex" title="Googleplex">Googleplex</a>", a play on words on the number <a href="/wiki/Googolplex" title="Googolplex">googolplex</a> and the headquarters itself being a <i>complex</i> of buildings. Internationally, Google has over 78 offices in more than 50 countries.<sup class="reference"><a href="#cite_note-237">[236]</a></sup></p>
   <p>In 2006, Google moved into about 300,000 square feet (27,900&nbsp;m<sup>2</sup>) of office space at <a href="/wiki/111_Eighth_Avenue" title="111 Eighth Avenue">111 Eighth Avenue</a> in <a href="/wiki/Manhattan" title="Manhattan">Manhattan</a>, <a href="/wiki/New_York_City" title="New York City">New York City</a>. The office was designed and built specially for Google, and houses its largest advertising sales team.<sup class="reference"><a href="#cite_note-238">[237]</a></sup> In 2010, Google bought the building housing the headquarter, in a deal that valued the property at around $1.9 billion.<sup class="reference"><a href="#cite_note-239">[238]</a></sup><sup class="reference"><a href="#cite_note-240">[239]</a></sup> In March 2018, Google's parent company Alphabet bought the nearby <a href="/wiki/Chelsea_Market" title="Chelsea Market">Chelsea Market</a> building for $2.4 billion. The sale is touted as one of the most expensive real estate transactions for a single building in the history of New York.<sup class="reference"><a href="#cite_note-241">[240]</a></sup><sup class="reference"><a href="#cite_note-242">[241]</a></sup><sup class="reference"><a href="#cite_note-243">[242]</a></sup><sup class="reference"><a href="#cite_note-244">[243]</a></sup> In November 2018, Google announced its plan to expand its New York City office to a capacity of 12,000 employees.<sup class="reference"><a href="#cite_note-245">[244]</a></sup> The same December, it was announced that a $1 billion, 1,700,000-square-foot (160,000&nbsp;m<sup>2</sup>) headquarters for Google would be built in Manhattan's <a href="/wiki/Hudson_Square" title="Hudson Square">Hudson Square</a> neighborhood.<sup class="reference"><a href="#cite_note-246">[245]</a></sup><sup class="reference"><a href="#cite_note-247">[246]</a></sup> Called Google Hudson Square, the new campus is projected to more than double the number of Google employees working in New York City.<sup class="reference"><a href="#cite_note-248">[247]</a></sup></p>
   <p>By late 2006, Google established a new headquarters for its AdWords division in <a href="/wiki/Ann_Arbor,_Michigan" title="Ann Arbor, Michigan">Ann Arbor, Michigan</a>.<sup class="reference"><a href="#cite_note-249">[248]</a></sup> In November 2006, Google opened offices on <a href="/wiki/Carnegie_Mellon" class="mw-redirect" title="Carnegie Mellon">Carnegie Mellon</a>'s campus in <a href="/wiki/Pittsburgh" title="Pittsburgh">Pittsburgh</a>, focusing on shopping-related advertisement coding and <a href="/wiki/Smartphone_applications" class="mw-redirect" title="Smartphone applications">smartphone applications</a> and programs.<sup class="reference"><a href="#cite_note-250">[249]</a></sup><sup class="reference"><a href="#cite_note-251">[250]</a></sup> Other office locations in the U.S. include <a href="/wiki/Atlanta,_Georgia" class="mw-redirect" title="Atlanta, Georgia">Atlanta, Georgia</a>; <a href="/wiki/Austin,_Texas" title="Austin, Texas">Austin, Texas</a>; <a href="/wiki/Boulder,_Colorado" title="Boulder, Colorado">Boulder, Colorado</a>; <a href="/wiki/Cambridge,_Massachusetts" title="Cambridge, Massachusetts">Cambridge, Massachusetts</a>; <a href="/wiki/San_Francisco" title="San Francisco">San Francisco</a>, <a href="/wiki/California" title="California">California</a>; <a href="/wiki/Seattle,_Washington" class="mw-redirect" title="Seattle, Washington">Seattle, Washington</a>; <a href="/wiki/Kirkland,_Washington" title="Kirkland, Washington">Kirkland, Washington</a>; <a href="/wiki/Birmingham,_Michigan" title="Birmingham, Michigan">Birmingham, Michigan</a>; <a href="/wiki/Reston,_Virginia" title="Reston, Virginia">Reston, Virginia</a>, and <a href="/wiki/Washington,_D.C." title="Washington, D.C.">Washington, D.C.</a><sup class="reference"><a href="#cite_note-252">[251]</a></sup></p>
   <div class="thumb tright">
      <div class="thumbinner" style="width:222px;">
   ...
   <p>It also has product research and development operations in cities around the world, namely <a href="/wiki/Sydney" title="Sydney">Sydney</a> (birthplace location of <a href="/wiki/Google_Maps" title="Google Maps">Google Maps</a>)<sup class="reference"><a href="#cite_note-253">[252]</a></sup> and <a href="/wiki/London" title="London">London</a> (part of <a href="/wiki/Android_(operating_system)" title="Android (operating system)">Android</a> development).<sup class="reference"><a href="#cite_note-254">[253]</a></sup> In November 2013, Google announced plans for a new <a href="/wiki/London" title="London">London</a> headquarter, a 1 million square foot office able to accommodate 4,500 employees. Recognized as one of the biggest ever commercial property acquisitions at the time of the deal's announcement in January,<sup class="reference"><a href="#cite_note-255">[254]</a></sup> Google submitted plans for the new headquarter to the <a href="/wiki/Camden_London_Borough_Council" title="Camden London Borough Council">Camden Council</a> in June 2017.<sup class="reference"><a href="#cite_note-256">[255]</a></sup><sup class="reference"><a href="#cite_note-257">[256]</a></sup> In May 2015, Google announced its intention to create its own campus in <a href="/wiki/Hyderabad" title="Hyderabad">Hyderabad</a>, India. The new campus, reported to be the company's largest outside the United States, will accommodate 13,000 employees.<sup class="reference"><a href="#cite_note-258">[257]</a></sup><sup class="reference"><a href="#cite_note-259">[258]</a></sup></p>
   ...
   <p><a href="/wiki/Google_data_centers" title="Google data centers">Google data centers</a> are located in North and South America, Asia, and Europe.<sup class="reference"><a href="#cite_note-260">[259]</a></sup> There is no official data on the number of <a href="/wiki/Server_(computing)" title="Server (computing)">servers</a> in Google data centers; however, research and advisory firm <a href="/wiki/Gartner" title="Gartner">Gartner</a> estimated in a July 2016 report that Google at the time had 2.5 million servers.<sup class="reference"><a href="#cite_note-261">[260]</a></sup> Traditionally, Google relied on <a href="/wiki/Parallel_computing" title="Parallel computing">parallel computing</a> on commodity hardware like mainstream x86 computers (similar to home PCs) to keep costs per query low.<sup class="reference"><a href="#cite_note-262">[261]</a></sup><sup class="reference"><a href="#cite_note-263">[262]</a></sup><sup class="reference"><a href="#cite_note-CNET2009-264">[263]</a></sup> In 2005, it started developing its own designs, which were only revealed in 2009.<sup class="reference"><a href="#cite_note-CNET2009-264">[263]</a></sup></p>
   <p>Google built its own private <a href="/wiki/Submarine_communications_cable" title="Submarine communications cable">submarine communications cables</a>; the first, named Curie, connects California with <a href="/wiki/Chile" title="Chile">Chile</a> and was completed on November 15, 2019.<sup class="reference"><a href="#cite_note-265">[264]</a></sup><sup class="reference"><a href="#cite_note-266">[265]</a></sup> The second fully Google-owned undersea cable, named Dunant, connects the United States with France and is planned to begin operation in 2020.<sup class="reference"><a href="#cite_note-267">[266]</a></sup> Google's third subsea cable, Equiano, will connect <a href="/wiki/Lisbon" title="Lisbon">Lisbon</a>, Portugal with <a href="/wiki/Lagos" title="Lagos">Lagos</a>, Nigeria and <a href="/wiki/Cape_Town" title="Cape Town">Cape Town</a>, South Africa.<sup class="reference"><a href="#cite_note-268">[267]</a></sup> The company's fourth cable, named Grace Hopper, connects landing points in New York, US, <a href="/wiki/Bude" title="Bude">Bude</a>, UK and <a href="/wiki/Bilbao" title="Bilbao">Bilbao</a>, Spain, and is expected to become operational in 2022.<sup class="reference"><a href="#cite_note-269">[268]</a></sup></p>
   <h3><span class="mw-headline" id="Environment">Environment</span></h3>
   <p>In October 2006, the company announced plans to install thousands of <a href="/wiki/Solar_panel" title="Solar panel">solar panels</a> to provide up to 1.6&nbsp;mega<a href="/wiki/Watt" title="Watt">watts</a> of electricity, enough to satisfy approximately 30% of the campus' energy needs.<sup class="reference"><a href="#cite_note-solar-270">[269]</a></sup><sup class="reference"><a href="#cite_note-271">[270]</a></sup> The system is the largest <a href="/wiki/Rooftop_photovoltaic_power_station" title="Rooftop photovoltaic power station">rooftop photovoltaic power station</a> constructed on a U.S. corporate campus and one of the largest on any corporate site in the world.<sup class="reference"><a href="#cite_note-solar-270">[269]</a></sup> Since 2007,<sup class="plainlinks noexcerpt noprint asof-tag update" style="display:none;"><a class="external text" href="https://en.wikipedia.org/w/index.php?title=Google&amp;action=edit">[update]</a></sup> Google has aimed for <a href="/wiki/Carbon_neutrality" title="Carbon neutrality">carbon neutrality</a> in regard to its operations.<sup class="reference"><a href="#cite_note-272">[271]</a></sup></p>
   <p>Google disclosed in September 2011 that it "continuously uses enough electricity to power 200,000 homes", almost 260 million watts or about a quarter of the output of a nuclear power plant. Total carbon emissions for 2010 were just under 1.5 million metric tons, mostly due to fossil fuels that provide electricity for the data centers. Google said that 25 percent of its energy was supplied by renewable fuels in 2010. An average search uses only 0.3 watt-hours of electricity, so all global searches are only 12.5 million watts or 5% of the total electricity consumption by Google.<sup class="reference"><a href="#cite_note-273">[272]</a></sup></p>
   <p>In 2010, <a href="/wiki/Google_Energy" class="mw-redirect" title="Google Energy">Google Energy</a> made its first investment in a <a href="/wiki/Renewable_energy" title="Renewable energy">renewable energy</a> project, putting $38.8&nbsp;million into two <a href="/wiki/Wind_farm" title="Wind farm">wind farms</a> in <a href="/wiki/North_Dakota" title="North Dakota">North Dakota</a>. The company announced the two locations will generate 169.5&nbsp;megawatts of power, enough to supply 55,000 homes.<sup class="reference"><a href="#cite_note-274">[273]</a></sup> In February 2010, the <a href="/wiki/Federal_Energy_Regulatory_Commission" title="Federal Energy Regulatory Commission">Federal Energy Regulatory Commission</a> FERC granted Google an authorization to buy and sell energy at market rates.<sup class="reference"><a href="#cite_note-275">[274]</a></sup> The corporation exercised this authorization in September 2013 when it announced it would purchase all the electricity produced by the not-yet-built 240-megawatt Happy Hereford wind farm.<sup class="reference"><a href="#cite_note-276">[275]</a></sup></p>
   <p>In July 2010, Google signed an agreement with an Iowa wind farm to buy 114 megawatts of power for 20 years.<sup class="reference"><a href="#cite_note-wind_energy-277">[276]</a></sup></p>
   <p>In December 2016, Google announced that—starting in 2017—it would purchase enough renewable energy to match 100% of the energy usage of its data centers and offices. The commitment will make Google "the world's largest corporate buyer of renewable power, with commitments reaching 2.6 gigawatts (2,600 megawatts) of wind and solar energy".<sup class="reference"><a href="#cite_note-278">[277]</a></sup><sup class="reference"><a href="#cite_note-279">[278]</a></sup><sup class="reference"><a href="#cite_note-280">[279]</a></sup></p>
   <p>In November 2017, Google bought 536 megawatts of wind power. The purchase made the firm reach <a href="/wiki/100%25_renewable_energy" title="100% renewable energy">100% renewable energy</a>. The wind energy comes from two power plants in South Dakota, one in Iowa and one in Oklahoma.<sup class="reference"><a href="#cite_note-281">[280]</a></sup> In September 2019, Google's chief executive announced plans for a $2 billion wind and solar investment, the biggest renewable energy deal in corporate history. This will grow their green energy profile by 40%, giving them an extra 1.6 gigawatt of clean energy, the company said.<sup class="reference"><a href="#cite_note-282">[281]</a></sup></p>
   <p>In September 2020, Google announced it had retroactively offset all of its carbon emissions since the company's foundation in 1998.<sup class="reference"><a href="#cite_note-283">[282]</a></sup> It also committed to operating its data centers and offices using only carbon-free energy by 2030.<sup class="reference"><a href="#cite_note-284">[283]</a></sup> In October 2020, the company pledged to make the packaging for its hardware products 100% plastic-free and 100% recyclable by 2025. It also said that all its final assembly manufacturing sites will achieve a <a href="/wiki/UL_(safety_organization)" title="UL (safety organization)">UL</a> 2799 <a href="/wiki/Zero_waste#Corporate_initiatives" title="Zero waste">Zero Waste to Landfill</a> certification by 2022 by ensuring that the vast majority of waste from the manufacturing process is recycled instead of ending up in a landfill.<sup class="reference"><a href="#cite_note-285">[284]</a></sup></p>
   <p>Google donates to politicians who deny climate change, including <a href="/wiki/Jim_Inhofe" title="Jim Inhofe">Jim Inhofe</a>, and sponsors <a href="/wiki/Climate_change_denial" title="Climate change denial">climate change denial</a> political groups including the <a href="/wiki/State_Policy_Network" title="State Policy Network">State Policy Network</a> and the <a href="/wiki/Competitive_Enterprise_Institute" title="Competitive Enterprise Institute">Competitive Enterprise Institute</a>.<sup class="reference"><a href="#cite_note-286">[285]</a></sup><sup class="reference"><a href="#cite_note-287">[286]</a></sup><sup class="reference"><a href="#cite_note-288">[287]</a></sup></p>
   ...
   <p>In 2004, Google formed the not-for-profit philanthropic <a href="/wiki/Google.org" title="Google.org">Google.org</a>, with a start-up fund of $1&nbsp;billion.<sup class="reference"><a href="#cite_note-philanthropy-289">[288]</a></sup> The mission of the organization is to create <a href="/wiki/Climate_change_education" title="Climate change education">awareness about climate change</a>, global public health, and global poverty. One of its first projects was to develop a viable <a href="/wiki/Plug-in_hybrid" title="Plug-in hybrid">plug-in hybrid</a> <a href="/wiki/Electric_vehicle" title="Electric vehicle">electric vehicle</a> that can attain 100 miles per gallon. Google hired <a href="/wiki/Larry_Brilliant" title="Larry Brilliant">Larry Brilliant</a> as the program's executive director in 2004<sup class="reference"><a href="#cite_note-290">[289]</a></sup> and Megan Smith has since<sup class="plainlinks noexcerpt noprint asof-tag update" style="display:none;"><a class="external text" href="https://en.wikipedia.org/w/index.php?title=Google&amp;action=edit">[update]</a></sup> replaced him as director.<sup class="reference"><a href="#cite_note-291">[290]</a></sup></p>
   <p>In 2008, Google announced its "project 10<sup>100</sup>" which accepted ideas for how to help the community and then allowed Google users to vote on their favorites.<sup class="reference"><a href="#cite_note-292">[291]</a></sup> After two years of silence, during which many wondered what had happened to the program,<sup class="reference"><a href="#cite_note-293">[292]</a></sup> Google revealed the winners of the project, giving a total of ten million dollars to various ideas ranging from non-profit organizations that promote education to a website that intends to make all legal documents public and online.<sup class="reference"><a href="#cite_note-294">[293]</a></sup></p>
   <p>In March 2007, in partnership with the <a href="/wiki/Mathematical_Sciences_Research_Institute" title="Mathematical Sciences Research Institute">Mathematical Sciences Research Institute</a> (MSRI), Google hosted the first <a href="/wiki/Julia_Robinson_Mathematics_Festival" title="Julia Robinson Mathematics Festival">Julia Robinson Mathematics Festival</a> at its headquarters in Mountain View.<sup class="reference"><a href="#cite_note-295">[294]</a></sup> In 2011, Google donated 1&nbsp;million euros to <a href="/wiki/International_Mathematical_Olympiad" title="International Mathematical Olympiad">International Mathematical Olympiad</a> to support the next five annual International Mathematical Olympiads (2011–2015).<sup class="reference"><a href="#cite_note-296">[295]</a></sup><sup class="reference"><a href="#cite_note-297">[296]</a></sup> In July 2012, Google launched a "<a href="/wiki/Legalize_Love" class="mw-redirect" title="Legalize Love">Legalize Love</a>" campaign in support of <a href="/wiki/Gay_rights" class="mw-redirect" title="Gay rights">gay rights</a>.<sup class="reference"><a href="#cite_note-298">[297]</a></sup></p>
   ...
   <p>Google has been involved in a number of lawsuits including the <a href="/wiki/High-Tech_Employee_Antitrust_Litigation" title="High-Tech Employee Antitrust Litigation">High-Tech Employee Antitrust Litigation</a> which resulted in Google being one of four companies to pay a $415 million settlement to employees.<sup class="reference"><a href="#cite_note-318">[317]</a></sup></p>
   <p>On June 27, 2017, the company received a record fine of <a href="/wiki/Euro" title="Euro">€</a>2.42 billion from the <a href="/wiki/European_Union" title="European Union">European Union</a> for "promoting its own shopping comparison service at the top of search results."<sup class="reference"><a href="#cite_note-319">[318]</a></sup> Commenting on the penalty, <i><a href="/wiki/New_Scientist" title="New Scientist">New Scientist</a></i> magazine said: "The hefty sum – the largest ever doled out by the EU's competition regulators – will sting in the short term, but Google can handle it. <a href="/wiki/Alphabet,_Inc." class="mw-redirect" title="Alphabet, Inc.">Alphabet</a>, Google’s parent company, made a profit of $2.5 billion (€2.2 billion) in the first six weeks of 2017 alone. The real impact of the ruling is that Google must stop using its dominance as a search engine to give itself the edge in another market: online price comparisons." The company disputed the ruling.<sup class="reference"><a href="#cite_note-320">[319]</a></sup> The hearing at the <a href="/wiki/General_Court_(European_Union)" title="General Court (European Union)">General Court of Luxembourg</a> was scheduled for 2020. The court is going to deliver the ultimate judgment by the end of the year.<sup class="reference"><a href="#cite_note-321">[320]</a></sup></p>
   <p>On July 18, 2018,<sup class="reference"><a href="#cite_note-322">[321]</a></sup> the <a href="/wiki/European_Commissioner_for_Competition" title="European Commissioner for Competition">European Commission</a> fined Google €4.34 billion for breaching EU antitrust rules. The abuse of dominant position has been referred to Google's constraint applied on Android device manufacturers and network operators to ensure that traffic on Android devices goes to the Google search engine. On October 9, 2018, Google confirmed<sup class="reference"><a href="#cite_note-323">[322]</a></sup> that it had appealed the fine to the <a href="/wiki/General_Court_(European_Union)" title="General Court (European Union)">General Court</a> of the European Union.<sup class="reference"><a href="#cite_note-324">[323]</a></sup></p>
   <p>On October 8, 2018, a class action lawsuit was filed against Google and Alphabet due to "non-public" Google+ account data being exposed as a result of a privacy bug that allowed app developers to gain access to the private information of users. The litigation was settled in July 2020 for $7.5 million with a payout to claimants of at least $5 each, with a maximum of $12 each.<sup class="reference"><a href="#cite_note-325">[324]</a></sup><sup class="reference"><a href="#cite_note-326">[325]</a></sup><sup class="reference"><a href="#cite_note-327">[326]</a></sup></p>
   <p>On January 21, 2019, French data regulator <a href="/wiki/CNIL" class="mw-redirect" title="CNIL">CNIL</a> imposed a record €50 million fine on Google for breaching the European Union's <a href="/wiki/General_Data_Protection_Regulation" title="General Data Protection Regulation">General Data Protection Regulation</a>. The judgment claimed Google had failed to sufficiently inform users of its methods for collecting data to personalize advertising. Google issued a statement saying it was “deeply committed” to transparency and was “studying the decision” before determining its response.<sup class="reference"><a href="#cite_note-328">[327]</a></sup></p>
   <p>On March 20, 2019, the European Commission imposed a €1.49 billion ($1.69 billion) fine on Google for preventing rivals from being able to “compete and innovate fairly” in the online advertising market.<sup class="reference"><a href="#cite_note-329">[328]</a></sup> European Union competition commissioner Margrethe Vestager said Google had violated EU antitrust rules by “imposing anti-competitive contractual restrictions on third-party websites” that required them to exclude search results from Google's rivals. Kent Walker, Google's senior vice-president of global affairs, said the company had “already made a wide range of changes to our products to address the Commission’s concerns,” and that "we'll be making further updates to give more visibility to rivals in Europe."<sup class="reference"><a href="#cite_note-330">[329]</a></sup></p>
   <p>After Congressional hearings in July 2020<sup class="reference"><a href="#cite_note-331">[330]</a></sup> and a report from the House of Representatives' antitrust subcommittee released in early October,<sup class="reference"><a href="#cite_note-332">[331]</a></sup> the <a href="/wiki/United_States_Department_of_Justice" title="United States Department of Justice">United States Department of Justice</a> filed an antitrust lawsuit against Google on October 20, 2020, asserting that it has illegally maintained its monopoly position in searching and search advertising.<sup class="reference"><a href="#cite_note-333">[332]</a></sup><sup class="reference"><a href="#cite_note-334">[333]</a></sup> The lawsuit included an accusation that Google engaged in anticompetitive behavior by paying Apple between $8 billion and $12 billion to be the default search engine on iPhones.<sup class="reference"><a href="#cite_note-335">[334]</a></sup> <a href="/wiki/Ken_Paxton" title="Ken Paxton">Ken Paxton</a>, a Texas Attorney General leading the suit, stated that "Google is a trillion-dollar monopoly brazenly abusing its monopolistic power, going so far as to induce senior Facebook executives to agree to a contractual scheme that undermines the heart of [the] competitive process." In part, the suit challenges <a href="/wiki/Alphabet_Inc." title="Alphabet Inc.">Alphabet's</a> capacity to fairly compete with the company in online advertising. No Democratic politicians joined Mr. Paxion in the suit. The majority of the accusations against Google involve their <a href="/wiki/List_of_advertising_technology_companies" title="List of advertising technology companies">ad-tech software</a>, of which Google owns the dominant tool at every link in the chain connecting online publishers and advertisers.<sup class="reference"><a href="#cite_note-336">[335]</a></sup> Later that month, both <a href="/wiki/Facebook" title="Facebook">Facebook</a> and Alphabet agreed to "cooperate and assist one another" in the face of investigation into their online advertising practices.<sup class="reference"><a href="#cite_note-337">[336]</a></sup><sup class="reference"><a href="#cite_note-338">[337]</a></sup></p>
      ...
      <div class="mw-references-wrap mw-references-columns">
         <ol class="references">
            ...
            <li id="cite_note-19">
               ...
               <span class="reference-text">
                  <link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r999302996">
                  <cite class="citation web cs1"><a rel="nofollow" class="external text" href="https://interbrand.com/best-global-brands/">"BEST GLOBAL BRANDS"</a>. <a href="/wiki/Interbrand" title="Interbrand">Interbrand</a>.</cite><span title="ctx_ver=Z39.88-2004&amp;rft_val_fmt=info%3Aofi%2Ffmt%3Akev%3Amtx%3Abook&amp;rft.genre=unknown&amp;rft.btitle=BEST+GLOBAL+BRANDS&amp;rft.pub=Interbrand&amp;rft_id=https%3A%2F%2Finterbrand.com%2Fbest-global-brands%2F&amp;rfr_id=info%3Asid%2Fen.wikipedia.org%3AGoogle" class="Z3988"></span>
               </span>
            </li>
            ...
            <li id="cite_note-10-K-183">
               <span class="mw-cite-backlink"><b><a href="#cite_ref-10-K_183-0" aria-label="Jump up" title="Jump up">^</a></b></span> 
               <span class="reference-text">
                  <link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r999302996">
            ...
            <li id="cite_note-Google-Inc-Jan-2012-10-K-184">
               <span class="mw-cite-backlink"><b><a href="#cite_ref-Google-Inc-Jan-2012-10-K_184-0" aria-label="Jump up" title="Jump up">^</a></b></span> 
               <span class="reference-text">
                  <link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r999302996">
            ...
            <li id="cite_note-Marketwatch-188">
               <span class="mw-cite-backlink"><b><a href="#cite_ref-Marketwatch_188-0" aria-label="Jump up" title="Jump up">^</a></b></span> 
               <span class="reference-text">
                  <link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r999302996">
            ...
            <li id="cite_note-mentalplex-207">
               <span class="mw-cite-backlink"><b><a href="#cite_ref-mentalplex_207-0" aria-label="Jump up" title="Jump up">^</a></b></span> 
               <span class="reference-text">
                  <link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r999302996">
            ...
            <li id="cite_note-TiSP-208">
               <span class="mw-cite-backlink"><b><a href="#cite_ref-TiSP_208-0" aria-label="Jump up" title="Jump up">^</a></b></span> 
               <span class="reference-text">
                  <link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r999302996">
            ...
            <li id="cite_note-209">
               <span class="mw-cite-backlink"><b><a href="#cite_ref-209" aria-label="Jump up" title="Jump up">^</a></b></span> 
               <span class="reference-text">
                  <link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r999302996">
            ...
            <li id="cite_note-233">
               <span class="mw-cite-backlink"><b><a href="#cite_ref-233" aria-label="Jump up" title="Jump up">^</a></b></span> 
               <span class="reference-text">
                  <link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r999302996">
            ...
            <li id="cite_note-265">
               <span class="mw-cite-backlink"><b><a href="#cite_ref-265" aria-label="Jump up" title="Jump up">^</a></b></span> 
               <span class="reference-text">
                  <link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r999302996">
            ...
            <li id="cite_note-philanthropy-289">
               <span class="mw-cite-backlink"><b><a href="#cite_ref-philanthropy_289-0" aria-label="Jump up" title="Jump up">^</a></b></span> 
               <span class="reference-text">
                  <link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r999302996">
         ...
         <tbody>
            <tr>
               <th scope="col" class="navbox-title" colspan="3">
                  ...
                  <div style="font-size:114%;margin:0 4em"><a class="mw-selflink selflink">Google</a></div>
               </th>
            </tr>
         ...
         <tbody>
            <tr>
               <th scope="col" class="navbox-title" colspan="3">
                  ...
                  <div style="font-size:114%;margin:0 4em"><a href="/wiki/Alphabet_Inc." title="Alphabet Inc.">Alphabet Inc.</a></div>
               </th>
            </tr>
            <tr style="display: none;">
         ...
         <tbody>
            <tr>
               <th scope="col" class="navbox-title" colspan="2" style="background:#e8e8ff;">
                  <span class="mw-collapsible-toggle mw-collapsible-toggle-default mw-collapsible-toggle-collapsed" role="button" tabindex="0" aria-expanded="false"><a class="mw-collapsible-text">show</a></span>
                  <div style="font-size:114%;margin:0 4em">Links to related articles</div>
               </th>
            </tr>
            <tr style="display: none;">
                           ...
                           <tbody>
                              <tr>
                                 <th scope="col" class="navbox-title" colspan="2">
                                    ...
                                    <div style="font-size:114%;margin:0 4em"><a href="/wiki/Open_Handset_Alliance" title="Open Handset Alliance">Open Handset Alliance</a></div>
                                 </th>
                              </tr>
                              <tr style="display: none;">
                           ...
                           <tbody>
                              <tr>
                                 <th scope="col" class="navbox-title" colspan="2">
                                    ...
                                    <div style="font-size:114%;margin:0 4em"><a href="/wiki/Google_Lunar_X_Prize" title="Google Lunar X Prize">Google Lunar X Prize</a></div>
                                 </th>
                              </tr>
                              <tr style="display: none;">
                           ...
                           <tbody>
                              <tr>
                                 <th scope="col" class="navbox-title" colspan="2">
                                    ...
                                    <div style="font-size:114%;margin:0 4em">Major <a href="/wiki/Mobile_device" title="Mobile device">mobile device</a> companies</div>
                                 </th>
                              </tr>
                              <tr style="display: none;">
                           ...
                           <tbody>
                              <tr>
                                 <th scope="col" class="navbox-title" colspan="2">
                                    ...
                                    <div style="font-size:114%;margin:0 4em">Major <a href="/wiki/Internet" title="Internet">Internet</a> companies</div>
                                 </th>
                              </tr>
                              <tr style="display: none;">
                                 <td class="navbox-abovebelow" colspan="2">
                           ...
                           <tbody>
                              <tr>
                                 <th scope="col" class="navbox-title" colspan="2">
                                    ...
                                    <div style="font-size:114%;margin:0 4em">Major <a href="/wiki/Software" title="Software">software</a> companies</div>
                                 </th>
                              </tr>
                              <tr style="display: none;">
                                 <td class="navbox-abovebelow" colspan="2">
                           ...
                           <tbody>
                              <tr>
                                 <th scope="col" class="navbox-title" colspan="3" style="background:#99d6ff;">
                                    ...
                                    <div style="font-size:114%;margin:0 4em">Laureates of the <a href="/wiki/Princess_of_Asturias_Awards" title="Princess of Asturias Awards">Prince or Princess of Asturias Award</a> for Communication and Humanities</div>
                                 </th>
                              </tr>
                              <tr style="display: none;">
                                       ...
                                       <tbody>
                                          <tr>
                                             <th scope="col" class="navbox-title" colspan="2" style="background:#addeff;">
                                                <div style="font-size:114%;margin:0 4em"><small>Prince of Asturias Award for Communication and Humanities</small></div>
                                             </th>
                                          </tr>
                                          <tr>
                                 ...
                                 <td colspan="2" class="navbox-list navbox-odd hlist" style="width:100%;padding:0px">
                                    ...
                                    <table class="nowraplinks navbox-subgroup" style="border-spacing:0">
                                       <tbody>
                                          <tr>
                                             <th scope="col" class="navbox-title" colspan="2" style="background:#addeff;">
                                                <div style="font-size:114%;margin:0 4em"><small>Princess of Asturias Award for Communication and Humanities</small></div>
                                             </th>
                                          </tr>
                                          <tr>
                                             <th scope="row" class="navbox-group" style="background:#addeff;;width:1%">2010s</th>
                           ...
                           <tbody>
                              <tr>
                                 <th scope="col" class="navbox-title" colspan="2">
                                    ...
                                    <div style="font-size:114%;margin:0 4em"><a href="/wiki/Electronics_industry_in_the_United_States" class="mw-redirect" title="Electronics industry in the United States">Electronics industry in the United States</a></div>
                                 </th>
                              </tr>
                              <tr style="display: none;">
